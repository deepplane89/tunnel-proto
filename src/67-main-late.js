...
const DR_SEQUENCE = [
  ...
  // CD_CANYON: PRE_T4A_CANYON (the snap-locked L3 knife variant was tried
  // here but had alignment issues, so it was removed).
...
// (Tutorial helpers + startTutorial/_maybeAutoStartTutorial moved to
// src/66-tutorial.js. Tutorial tick remains in this file inside animate().)
