...
const SHIP_SKINS = [
  ...
  { name: 'RUNNER MK II',    price: 0,    description: 'Upgraded Runner',   glbFile: 'spaceship_01.glb',
    ...
    glbConfig: { posX:0, posY:-0.590, posZ:0, rotX:0, rotY:3.142, rotZ:0, scale:1.0,
      ...
      // 2026-05-01: per user, MK runner main nozzleL/R set IDENTICAL to RUNNER defaults
      // (NOZZLE_OFFSETS) — GLBs are physically the same ship. Mini thrusters kept at
      // their prior MK-specific values per user feedback.
