...
const SHIP_SKINS = [
  ...
  { name: 'PHOENIX',        price: 0,    description: 'Stellar Phoenix',   glbFile: 'stellar_phoenix.glb',
    glbConfig: { posX:0, posY:0, posZ:3.000, rotX:0, rotY:3.142, rotZ:0, scale:0.351,
      ...
      animated: true, stripTextures: true } },
  { name: 'RUNNER MK II',    price: 0,    description: 'Upgraded Runner',   glbFile: 'spaceship_01.glb',
    glbConfig: { posX:0, posY:-0.5, posZ:0, rotX:0, rotY:3.142, rotZ:0, scale:1.0,
      nozzleL:[-1.50,-0.50,2.20], nozzleR:[1.50,-0.50,2.20],
      miniL:[-0.80,-0.50,2.00], miniR:[0.80,-0.50,2.00], thrusterScale:1.0,
      matchDefault: true },
